...
-- Retrieve the number of roles that need to be filled in each department.
...
-- Retrieve the number of retirement-ready employees in the departments eligible for mentorship.
SELECT COUNT(emp_no), dept_name
